...
\restrict tsRsqmYEr8hEIrfQxYLu92rmKk5J3OZcDuxhT5hs31VeBXZKjBXQIqhb5FjyngB
...
--
-- Name: customer; Type: TABLE; Schema: public; Owner: Gilat
--
...
ALTER TABLE public.customer OWNER TO "Gilat";

--
-- Name: difficultylevel; Type: TABLE; Schema: public; Owner: Gilat
--
...
ALTER TABLE public.difficultylevel OWNER TO "Gilat";

--
-- Name: guide; Type: TABLE; Schema: public; Owner: Gilat
--
...
ALTER TABLE public.guide OWNER TO "Gilat";

--
-- Name: guidedtour; Type: TABLE; Schema: public; Owner: Gilat
--
...
ALTER TABLE public.guidedtour OWNER TO "Gilat";

--
-- Name: payment; Type: TABLE; Schema: public; Owner: Gilat
--
...
ALTER TABLE public.payment OWNER TO "Gilat";

--
-- Name: paymentstatus; Type: TABLE; Schema: public; Owner: Gilat
--
...
ALTER TABLE public.paymentstatus OWNER TO "Gilat";

--
-- Name: registration; Type: TABLE; Schema: public; Owner: Gilat
--
...
ALTER TABLE public.registration OWNER TO "Gilat";

--
-- Name: registrationstatus; Type: TABLE; Schema: public; Owner: Gilat
--
...
ALTER TABLE public.registrationstatus OWNER TO "Gilat";

--
-- Name: route; Type: TABLE; Schema: public; Owner: Gilat
--
...
ALTER TABLE public.route OWNER TO "Gilat";

--
-- Name: tourstatus; Type: TABLE; Schema: public; Owner: Gilat
--
...
ALTER TABLE public.tourstatus OWNER TO "Gilat";
...
\unrestrict tsRsqmYEr8hEIrfQxYLu92rmKk5J3OZcDuxhT5hs31VeBXZKjBXQIqhb5FjyngB
